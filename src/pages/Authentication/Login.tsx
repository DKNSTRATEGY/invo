...
const Login = (props:any) => {
  document.title = "Login | DKN Invoice Portal";
                                    ...
                                    <div className="d-flex flex-column h-100 py-0 py-xl-4">
                                                ...
                                                <Col lg={6}>
                                                    <Card.Body className="p-lg-5 p-4">
                                                        <div className="text-center">
                                                            ...
                                                            <p className="text-muted mt-2">Sign in to continue to DKN Invoice Portal.</p>
                                                        </div>
                                        ...
                                        <div className="mt-5 text-center">
                                            <p className="mb-0 text-muted">
                                                &copy; {new Date().getFullYear()} Dknstrategy Co Ltd. Crafted with Presision by Sia Square
                                            </p>
                                        </div>
                                    </div>
                                </div>
