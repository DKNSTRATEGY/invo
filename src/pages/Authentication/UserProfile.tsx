...
const UserProfile = () => {
  document.title = "User Profile | DKN Invoice Portal";
                                    ...
                                    <div className="d-flex flex-column h-100 py-0 py-xl-4">
                                        ...
                                        <div className="mt-5 text-center">
                                            <p className="mb-0 text-muted">
                                                &copy; {new Date().getFullYear()} Dknstrategy Co Ltd. Crafted with <i className="mdi mdi-heart text-danger"></i> by Sia Square
                                            </p>
                                        </div>
                                    </div>
                                </div>
