...
const Register = () => {
    document.title = "Register | DKN Invoice Portal";
                                ...
                                <div className="d-flex flex-column h-100 py-0 py-xl-4">
                                                ...
                                                <Col lg={6}>
                                                    <div className="p-lg-5 p-4">
                                                        <div className="text-center">
                                                            ...
                                                            <p className="text-muted mt-2">Get your DKN Invoice Portal account now</p>
                                                        </div>
                                                        ...
                                                        <Form className="needs-validation"
                                                            ...
                                                            <Form.Group className="mb-3">
                                                                ...
                                                                <div className="fs-16 pb-2">
                                                                    <p className="mb-0 fs-14 text-muted fst-italic">By registering you agree to the Dknstrategy Co Ltd <Link to="#" className="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</Link></p>
                                                                </div>
                                    ...
                                    <div className="mt-5 text-center">
                                        <p className="mb-0 text-muted">©
                                            <script>document.write(new Date().getFullYear())</script> Dknstrategy Co Ltd. Crafted with presision by Sia Square
                                        </p>
                                    </div>
                                </div>
                            </div>
