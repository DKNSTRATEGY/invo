...
const Borders = () => {
    document.title=" Utilities | DKN Invoice Portal";

    return (
        <React.Fragment>
            <div className="page">
                <Breadcrumb pageTitle="Base Ui" title="Utilities" />
                <Row>
                    <Col lg={12}>
                        <Card>
                            <Card.Header>
                            ...
                            <Card.Body>
                                ...
                                <div className="live-preview">
                                    <div>
                                        <div>
                                            <h5 className="fs-sm mb-3">Border width</h5>
                                        ...
                                        <Row className="mt-4">
                                            <Col lg={6}>
                                                <div>
                                                    <h5 className="fs-sm mb-3">Additive</h5>
                                                    <Row>
                                                        <Col xl={2} sm={4}>
                                                            <div className="text-center">
                                            ...
                                            <Col lg={6}>
                                                <div>
                                                    <h5 className="fs-sm mb-3">Subtractive</h5>
                                                    <Row>
                                                        <Col xl={2} sm={4}>
                                                            <div className="text-center">
                                        ...
                                        <div className="mt-4">
                                            <h5 className="fs-sm mb-3">Border Color</h5>
                                            <div className="d-flex align-items-start flex-wrap gap-4">
                                                <div className="text-center">
                                        ...
                                        <Row className="mt-4">
                                            <Col xxl={6}>
                                                <div>
                                                    <h5 className="fs-sm mb-3">Border Style</h5>
                                                    <div className="d-flex align-items-start flex-wrap gap-4">
                                                        <div className="text-center">
                                        ...
                                        <div className="mt-4">
                                            <h5 className="fs-sm mb-3">Border Opacity</h5>
                                            <div className="d-flex align-items-start flex-wrap gap-4">
                                                <div className="text-center">
