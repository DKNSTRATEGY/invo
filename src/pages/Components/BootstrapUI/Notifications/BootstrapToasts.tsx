...
const BootstrapToasts = () => {
    document.title=" Notifications | DKN Invoice Portal";
    ...
    return (
        <React.Fragment>
            <div className="page">
                <Breadcrumb pageTitle="Bootstrap Ui" title="Notifications" />
                <Row>
                    <Col lg={12}>
                        <Card>
                            <Card.Header>
                            ...
                            <Card.Body>
                                <div>
                                    <Row className="g-3">
                                        <Col xxl={6}>
                                            <h5 className="fs-md mb-3">Default Toast</h5>
                                            ...
                                            <div className="mt-4">
                                                <h5 className="fs-md">Translucent</h5>
                                        ...
                                        <Col xxl={6}>
                                            <div>
                                                <h5 className="fs-md">Stacking</h5>
                                    ...
                                    <div className="mt-5">
                                        <h5 className="fs-md">Placement</h5>
                                        <Row className="g-3">
                                            <Col xxl={6}>
                                                <div>
