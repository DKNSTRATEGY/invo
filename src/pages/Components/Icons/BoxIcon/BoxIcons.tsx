...
const BoxIcons = () => {
  document.title=" Boxicons | DKN Invoice Portal";

  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumb pageTitle="Icons" title="BoxIcons" />
          <Row>
            <Col className="col-12">
              <Card>
                <Card.Header>
                  <h4 className="card-title">Examples</h4>
                  <p className="text-muted mb-0">Use <code>&lt;i class="bx bx-**"{'>'}&lt;/i{'>'}</code> class.</p>
                </Card.Header>
                <Card.Body>
                  ...
                  <p className="text-muted mb-0">Use class <code>&lt;i class="bx bxs-**"{'>'}&lt;/i{'>'}</code></p>
                  ...
                  <p className="text-muted mb-0">Use class <code>&lt;i class="bx bl-**"{'>'}&lt;/i{'>'}</code></p>
                  <Row className="icon-demo-content">
                    <Col xl={3} lg={4} sm={6}>
