...
const ProgressArrowNav = () => {
    document.title=" Wizard | DKN Invoice Portal";
    ...
    return (
        <React.Fragment>
            <div className="page">
                <Breadcrumb pageTitle="Forms" title="Forms Wizard" />
                <Row>
                    <Col xl={6}>
                        <Card>
                            <Card.Header>
                                        ...
                                        <Tab.Content>
                                            <Tab.Pane eventKey="0" id="pills-gen-info" role="tabpanel" aria-labelledby="pills-gen-info-tab">
                                                ...
                                                <div className="d-flex align-items-start gap-3 mt-4">
                                                    <button type="button" className="btn btn-success btn-label right ms-auto nexttab nexttab" onClick={() => setactiveTab(1)}><i className="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Go to more info</button>
                                                </div>
                                            </Tab.Pane>
                                            ...
                                            <Tab.Pane eventKey="1" id="pills-info-desc" role="tabpanel" aria-labelledby="pills-info-desc-tab">
                                                <div>
                                                    <div className="text-center">
                                                        ...
                                                        <h5 className="fs-md">Add Image</h5>
                                                ...
                                                <div className="d-flex align-items-start gap-3 mt-4">
                                                    <button type="button" className="btn btn-link text-decoration-none btn-label previestab" onClick={() => setactiveTab(0)}><i className="ri-arrow-left-line label-icon align-middle fs-lg me-2"></i> Back to General</button>
                                                    <button type="button" className="btn btn-success btn-label right ms-auto nexttab nexttab" onClick={() => setactiveTab(2)}><i className="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Submit</button>
                                                </div>
                                            </Tab.Pane>
                                    ...
                                    <Tab.Container activeKey={activeArrowTab}>
                                        ...
                                        <Tab.Content>
                                            <Tab.Pane eventKey="1">
                                                ...
                                                <div className="d-flex align-items-start gap-3 mt-4">
                                                    <button type="button" className="btn btn-success btn-label right ms-auto nexttab nexttab" onClick={() => setactiveArrowTab(2)}><i className="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Go to more info</button>
                                                </div>
                                            </Tab.Pane>
                                            ...
                                            <Tab.Pane eventKey="2">
                                                ...
                                                <div className="d-flex align-items-start gap-3 mt-4">
                                                    <button type="button" className="btn btn-light btn-label previestab" onClick={() => setactiveArrowTab(1)}><i className="ri-arrow-left-line label-icon align-middle fs-lg me-2"></i> Back to General</button>
                                                    <button type="button" className="btn btn-success btn-label right ms-auto nexttab nexttab" onClick={() => setactiveArrowTab(3)}><i className="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Submit</button>
                                                </div>
                                            </Tab.Pane>
                                            <Tab.Pane eventKey="3">
                                                <div className="text-center">
