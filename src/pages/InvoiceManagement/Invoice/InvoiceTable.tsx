...
import { getClientInvoices as onGetClientInvoices,
        ...
        () => [
          ...
          },
          {
            ...
            Cell: (cell: any) => {
              ...
              return (     
                <div>
                    <img src={cell.row.original.clientImage} alt="" className="avatar-xs rounded-circle me-2" />
                    <Link to="#" className="text-body align-middle fw-medium">{cell.row.original.clientName}</Link>   
                </div>                           
              )
            }
          },          
            ...
            Cell: (cell: any) => (
                        <Dropdown>
                            ...
                            <Dropdown.Menu className="dropdown-menu-end">
                                <li>
                                    <Dropdown.Item as={Link} to="#"><i className="las la-eye fs-18 align-middle me-2 text-muted"></i>
                                        View</Dropdown.Item>
                                </li>
                                <li>
                                ...
                                <li>
                                    <Dropdown.Item as={Link} to="#"><i className="las la-file-download fs-18 align-middle me-2 text-muted"></i>
                                        Download</Dropdown.Item>
                                </li>
                                <li className="dropdown-divider"></li>
                                <li>
                                    <Dropdown.Item className="remove-item-btn" as={Link} to="#"
