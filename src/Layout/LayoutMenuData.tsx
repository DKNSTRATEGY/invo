...
const Navdata = () => {
    ...
    const menuItems: any = [
        ...
        
        {
            ...
            { id: 1, label: "Invoice History",icon: "bx bx-file-find",link: "/invoice", parentId: "invoiceManagement" },
            { id: 2, label: "Add Invoice", icon:"mdi mdi-file-sign" ,link: "/invoice-add", parentId: "invoiceManagement" },
            { id: 2, label: "Invoice Details",icon:"las la-file-invoice", link: "/invoice-details", parentId: "invoiceManagement" },
            { id: 3, label: "Payments", icon: "mdi mdi-account-cash" ,link: "/payments", parentId: "invoiceManagement" },
            { id: 4, label: "Taxes",icon:"mdi mdi-bank" , link: "/taxes", parentId: "invoiceManagement" },
            {
            ...
            //subItems: [
                ...
                
                {
                    ...
                    subItems: [
                        { id: 1, label: "New Transaction", link: "/transaction-new", parentId: "invoiceManagement" },
                        { id: 2, label: "Transaction List", link: "/transaction-list", parentId: "invoiceManagement" },                        
        ...
        { id:7, label: "Users",icon:"bx bx-user", link: "/user" },
